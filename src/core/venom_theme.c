 ...
 * 
 * venom_theme.c - Theming system implementation
 */
...
static const VenomTheme light_theme = {
    .name = "Light",
    .is_dark = VENOM_FALSE,
    ...
    .typography = {
        .h1 = { "Noto Sans", 96.0f, 1.1f, -1.5f, VENOM_FALSE, VENOM_FALSE },
        .h2 = { "Noto Sans", 60.0f, 1.1f, -0.5f, VENOM_FALSE, VENOM_FALSE },
        .h3 = { "Noto Sans", 48.0f, 1.2f, 0, VENOM_FALSE, VENOM_FALSE },
        .h4 = { "Noto Sans", 34.0f, 1.2f, 0.25f, VENOM_FALSE, VENOM_FALSE },
        .h5 = { "Noto Sans", 24.0f, 1.3f, 0, VENOM_FALSE, VENOM_FALSE },
        .h6 = { "Noto Sans", 20.0f, 1.3f, 0.15f, VENOM_TRUE, VENOM_FALSE },
        .body1 = { "Noto Sans", 16.0f, 1.5f, 0.5f, VENOM_FALSE, VENOM_FALSE },
        .body2 = { "Noto Sans", 14.0f, 1.5f, 0.25f, VENOM_FALSE, VENOM_FALSE },
        .caption = { "Noto Sans", 12.0f, 1.4f, 0.4f, VENOM_FALSE, VENOM_FALSE },
        .button = { "Noto Sans", 14.0f, 1.25f, 1.25f, VENOM_TRUE, VENOM_FALSE },
        .overline = { "Noto Sans", 10.0f, 1.5f, 2.0f, VENOM_TRUE, VENOM_FALSE },
    },
...
static const VenomTheme dark_theme = {
    .name = "Dark",
    .is_dark = VENOM_TRUE,
...
static const VenomTheme* current_theme = &light_theme;
...
VenomTheme venom_theme_create(VenomColor primary, VenomColor secondary, VenomBool is_dark) {
    VenomTheme theme = is_dark ? dark_theme : light_theme;
