...
int main(int argc, char** argv) {
    ...
    while (running) {
        ...
        /* Clock text placeholder */
        VenomPaint text_paint = venom_paint_fill(venom_color_rgba(255, 255, 255, 255));
        VenomRectF time_rect = { clock_x + 12, 8, 46, 10 };
        venom_canvas_draw_rect(panel_canvas, time_rect, &text_paint);
        
        /* Battery */
        draw_battery_icon(panel_canvas, screen_width - 65, 8, g_state.battery_percent, g_state.battery_charging);
